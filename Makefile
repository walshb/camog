...
test:	all
	export PYTHONPATH=$$(readlink -f $(CURDIR)/build/lib*); cd tests; python -m pytest -sv test_fastcsv.py test_headers.py test_edge.py test_file.py test_api.py test_format.py test_numbers.py
